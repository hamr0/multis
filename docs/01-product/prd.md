...
### M11 — foundation refresh: bareguard 0.7→0.9 + bare-agent 0.16.1→0.18+ *(dep: M2; current-izes the M2 pin; M6 "thin the loop" rides the refreshed loop)* — **NOT STARTED (planned 2026-06-25)**
